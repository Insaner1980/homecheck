...
class PlayBillingManager @Inject constructor(
    ...
    private fun processPurchases(purchases: List<Purchase>, ownedEvent: BillingEvent?) {
        val ownedIds = purchases
    ...
    private fun emitResult(responseCode: Int) {
        mutableEvents.tryEmit(when (responseCode) {
            ...
            BillingClient.BillingResponseCode.SERVICE_UNAVAILABLE -> BillingEvent.UNAVAILABLE
